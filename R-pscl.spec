...
Source0  : https://cran.r-project.org/src/contrib/pscl_1.5.2.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1530406390
...
R CMD check --no-manual --no-examples --no-codoc -l %{buildroot}/usr/lib64/R/library pscl|| : 
cp ~/.stash/* %{buildroot}/usr/lib64/R/library/*/libs/ || :
...
/usr/lib64/R/library/pscl/libs/symbols.rds
